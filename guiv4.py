...
class TrainingViewer:
    def __init__(self, root):
        ...
        # Metrics labels for current epoch
        ...
        self.lpips_label = Label(root, text="LPIPS: ", font=("Arial", 14))
        self.lpips_label.grid(row=1, column=2, padx=10, pady=10, sticky="w")
        ...
        # Search bar for jumping to a specific epoch
        ...
        self.refresh_button.grid(row=7, column=0, columnspan=3, padx=10, pady=10)
